...
async function deposit() {
  ...
  return `ZeroMixer-eth-${AMOUNT}-${netId}-${toHex(deposit.preimage, 62)}`
}
...
async function main() {
  ...
  contract = new web3.eth.Contract(require('../build/contracts/ETHZeroMixer.json').abi, CONTRACT_ADDRESS)
